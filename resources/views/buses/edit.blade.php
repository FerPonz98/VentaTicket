      ...
      Editar Bus
        ...
        <div class="sm:col-span-2">
          ...
          <input
            ...
            value="{{ old('tarjeta_operacion_vencimiento', $bus->tarjeta_operacion_vencimiento ? $bus->tarjeta_operacion_vencimiento->format('Y-m-d') : '') }}"
            class="w-full bg-gray-50 border border-gray-300 rounded px-4 py-2 focus:ring-2 focus:ring-indigo-500 text-gray-900"
          />
        ...
        <input type="hidden" id="layout1" name="layout_piso1" value='@json(old("layout_piso1", $bus->layout_piso1 ?? []))'>
        <input type="hidden" id="layout2" name="layout_piso2" value='@json(old("layout_piso2", $bus->layout_piso2 ?? []))'>
      </form>
    </div>
  </div>
